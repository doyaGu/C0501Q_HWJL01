    ...
    void**              pptSample)
{
    ...
    *pptSample = (void*) (ptQueue->pOutPesBuffer
                       + (ptQueue->pesBufferWriteIdx * ptQueue->pOutPesSampleSize));
    return QUEUE_NO_ERROR;
}
...
//
//        ptQueue->ptPidInfo->pesBufferReadIdx = 0;
//        return QUEUE_NO_ERROR;
//    }
//    return QUEUE_INVALID_INPUT;
//}
    ...
    uint*               ptCount)
{
    ...
    if (!ptQueue->ptPidInfo)
        return QUEUE_NOT_EXIST;

    ptQueue->pesBufferReadIdx = GET32(ptQueue->ptPidInfo->pesBufferReadIdx);
    *ptCount = (ptQueue->pesBufferWriteIdx >= ptQueue->pesBufferReadIdx)
