...
uint64_t __div64_32(uint64_t n, uint32_t base)
{
    uint64_t rem = n;
    uint64_t b = base;
    uint64_t res, d = 1;
...
int a52_downmix_init(int input, int flags, level_t * level, level_t clev, level_t slev)
{
    ...
    if (flags & A52_ADJUST_LEVEL) {
        ...
        case CONVERT(A52_3F, A52_MONO):
            adjust = (level_t)DIV(LEVEL_3DB, LEVEL(1) + clev);
            break;
        ...
        case CONVERT(A52_3F2R, A52_2F2R):
            adjust = (level_t)DIV(1, LEVEL(1) + clev);
            break;

        case CONVERT(A52_2F1R, A52_MONO):
            adjust = (level_t)DIV(LEVEL_PLUS3DB, LEVEL(2) + slev);
            break;

        case CONVERT(A52_2F1R, A52_STEREO):
        case CONVERT(A52_3F1R, A52_3F):
            adjust = (level_t)DIV(1, LEVEL(1) + MUL_C(slev, LEVEL_3DB));
            break;
