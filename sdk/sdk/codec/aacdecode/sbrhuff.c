...
/**************************************************************************************
 * Function:    DecodeHuffmanScalar_l
 *
 ...
 *                  (since count[nBits] = 0)
 **************************************************************************************/
static int DecodeHuffmanScalar_l(const signed short *huffTab, const HuffInfo *huffTabInfo, unsigned int bitBuf, signed int *val)
{
...
static int DecodeOneSymbol(BitStreamInfo *bsi, int huffTabIndex)
{
    ...
    nBits = DecodeHuffmanScalar_l(huffTabSBR, hi, bitBuf, &val);
