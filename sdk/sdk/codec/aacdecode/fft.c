    ...
    for (; bg != 0; gp <<= 2, bg >>= 2) {
        ...
        for (i = bg; i != 0; i--) {
            ...
            for (j = gp; j != 0; j--) {
                ...
                bi = xptr[1];
                tr = br;
                br = MULSHIFT32_SUB(wr, br, wi, bi);   /* cos*br + sin*bi */
                bi = MULSHIFT32_ADD(wr, bi, wi, tr);   /* cos*bi - sin*br */
                xptr += step;
                ...
                ci = xptr[1];
                tr = cr;
                cr = MULSHIFT32_SUB(wr, cr, wi, ci);
                ci = MULSHIFT32_ADD(wr, ci, wi, tr);
                xptr += step;
                ...
                di = xptr[1];
                tr = dr;
                dr = MULSHIFT32_SUB(wr, dr, wi, di);
                di = MULSHIFT32_ADD(wr, di, wi, tr);
                wptr += 6;
