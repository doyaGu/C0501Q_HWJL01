...
{
    int nsamples = IOBuf->nsamples;
    int (*buf)[MAX_FRAMESIZE] = (int(*)[MAX_FRAMESIZE])IOBuf->buf;
///////////////////////////////////////////////////////////////////////////
// simple voice off
///////////////////////////////////////////////////////////////////////////
#if defined(SIMPLE_VOICEOFF)
    int i;
    ...
    for(i=0; i<nsamples; i++){
        int val = (int)buf[0][i] - (int)buf[1][i];
        buf[0][i] = (val*3)/2;
        buf[1][i] = (-val*3)/2;
    }
///////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////
    ...
    for(i=0; i<nsamples; i++){
        ...
        // Cut the center
        buf[0][i] = left  - ((right * LEVEL) >> LEVEL_PRECESION) + o;
        buf[1][i] = right - ((left  * LEVEL) >> LEVEL_PRECESION) + o;
    }
#else
