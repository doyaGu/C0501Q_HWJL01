...
Word16 add (Word16 var1, Word16 var2)
{
    Word16 var_out;
//#ifdef __OR32__
//  asm ("l.addhs %0, %1, %2" : "=r"(var_out) : "r"(var1), "r"(var2));
//#else
    Word32 L_sum;
...
//            var2 = 16;
    ...
    {
//#ifdef __OR32__
//      asm volatile ("l.slls %0, %1, %2" : "=r"(result) : "r"((Word32)(var1 << 16)), "r"((Word32)var2) );
//#else
//      result = L_shl(var1 << 16, var2);
...
Word16 shr (Word16 var1, Word16 var2)
{
  ...
  //          var2 = 16;
    ...
    {
        // sis3830
        // OpenRISC support arithmetic right shift
        if (var2 >= 15)
        {
            var_out = (var1 < 0) ? -1 : 0;
        }
...
Word16 mult (Word16 var1, Word16 var2)
{
    ...
    // sis3830
    //var_out = extract_h( L_mult(var1, var2)  );
    var_out = (Word16) (L_mult(var1, var2) >> 16);
#if (WMOPS)
...
Word32 L_mult (Word16 var1, Word16 var2)
{
    ...
    {
    //  L_var_out *= 2;
    // sis3830 shift is slower than mult?!
        L_var_out <<= 1;
    }
    else
    {
...
Word16 round16(Word32 L_var1)
{
    ...
    Word32 L_rounded;
//#ifdef __OR32__
//  asm ("l.adds %0, %1, %2" : "=r"(L_rounded) : "r"(L_var1), "r"(0x00008000L));
//#else
...
Word32 L_add (Word32 L_var1, Word32 L_var2)
{
    Word32 L_var_out;
//#ifdef __OR32__
//  asm ("l.adds %0, %1, %2" : "=r"(L_var_out) : "r"(L_var1), "r"(L_var2));
//#else
...
Word32 L_add_c (Word32 L_var1, Word32 L_var2)
{
    ...
    if (Carry)
    {
        if (L_test == MAX_32)
        {
            // sis3830 ought to be consider in the above IF cases
            //Overflow = 1;
            Carry = carry_int;
        }
        else
...
Word32 L_sub_c (Word32 L_var1, Word32 L_var2)
{
    ...
    else
    {
        ...
        if (L_test == MIN_32)
        {
            // sis3830 overflow ought to be consided in above IF case
            //Overflow = 1;
            Carry = carry_int;
        }
        else
...
#endif
   L_product_arr = L_mac ( 0x00008000L, var1, var2 );
   //var_out = extract_h( L_product_arr );
   var_out = (Word16) (L_product_arr >> 16);
    return (var_out);
}
...
// 2004.9.9 sis3830
//#ifdef __OR32__
//        asm ("l.slls %0, %1, %2" : "=r"(L_var_out) : "r"((Word32)L_var1), "r"((Word32)var2) );
//#else
        for (; var2 > 0; var2--)
        {
...
//#endif
    // sis3830
    //var_out = shr (var1, var2);
    //if (var1 & ((Word16) 1 << (var2 - 1)))
    //            var_out++;
    var_out = var1 + ((Word16) 1 << (var2 - 1));
...
Word16 mac_r (Word32 L_var3, Word16 var1, Word16 var2)
{
    ...
    var_out = (Word16) (L_add (L_var3, (Word32) 0x00008000L));
#if (WMOPS)
    multiCounter[currCounter].extract_h--;
...
//#ifdef __OR32__
//          asm volatile("l.ff1 %0, %1, r0" : "=r"(var_out) : "r"(L_var1));
//          var_out = 32 - var_out;
//#else
