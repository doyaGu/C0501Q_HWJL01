    ...
    {               /* i is stage counter */
        ...
        {                   /* j is sample counter */
            ...
            {               /* k is butterfly top */
                ...
                tmp1 = round16(ftmp_real);
                tmp2 = round16(ftmp_imag);
