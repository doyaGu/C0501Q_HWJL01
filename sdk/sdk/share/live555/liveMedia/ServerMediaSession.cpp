...
static char const* const libNameStr = "RTSP Streaming Media v";
...
ServerMediaSession::addSubsession(ServerMediaSubsession* subsession) {
  if (!subsession || subsession->fParentSession != NULL) return False; // it's already used
...
char* ServerMediaSession::generateSDPDescription() {
  ...
  do {
    ...
    sprintf(sdp, sdpPrefixFmt,
	    (unsigned long)fCreationTime.tv_sec, (unsigned long)fCreationTime.tv_usec, // o= <session id>
