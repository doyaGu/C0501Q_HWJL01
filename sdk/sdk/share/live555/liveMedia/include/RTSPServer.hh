...
#define RTSP_BUFFER_SIZE 10000 // for incoming requests, and outgoing responses
    ...
    #define SERVICE_NAME_MAX_LENGTH     32 // for CFG_DEMOD_ENABLE
#endif
...
#if defined(CFG_DEMOD_ENABLE)
    Boolean isServiceIdle(char const *streamName);
protected:
    struct sockaddr_in fIncomingClientAddr;
...
#if defined(CFG_DEMOD_ENABLE)
    char    fClient_streamName[SERVICE_NAME_MAX_LENGTH];
#endif
  };
