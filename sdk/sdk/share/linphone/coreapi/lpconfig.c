...
static void lp_config_sync_notify_callback_default(char* filename)
{
}
void (*lp_config_sync_notify_callback)(char* filename) = lp_config_sync_notify_callback_default;
...
int lp_config_sync(LpConfig *lpconfig){
	...
	fclose(file);
	lpconfig->modified=0;
    lp_config_sync_notify_callback(lpconfig->filename);
	return 0;
}
