...
int proxy_set_in_indoor()
{
    ...
    memcpy(gProxyOutsideIP,ipaddr_ntoa((const ip_addr_t *)&info.address),sizeof(gProxyOutsideIP));

    //printf(" IF_INBOUND %s , %s, outside %s ,%s \n",gProxyInIndoorIP,gProxyInternalIndoorIP,gProxyOutsideIP,ipaddr_ntoa((const ip_addr_t *)&info.address));
    return 0;
