...
// nRTP:0 ,default need rtp relay, 1 don't use rtp relay
int proxy_rewrite_invitation_body(sip_ticket_t *ticket, int direction,int nRTP); /*X*/
// rewrite internal indoor sdp
...
void CvtHexSip(unsigned char *hash, unsigned char *hashstring);
...
/**
 * The entry point of siproxd task. The application need to create a task to run this function.
 *
...
#define URLMAP_INDEX_SIZE 5	/* max number of URL mapping table entries	*/
