...
static enum PixelFormat inSrc_mjpeg_fmts[3] = {PIX_FMT_YUVJ420P, PIX_FMT_YUVJ422P, PIX_FMT_NONE};
static enum PixelFormat inSrc_amv_fmts[3] = {PIX_FMT_YUVJ420P, PIX_FMT_YUVJ422P, -1};
AVCodec ff_mjpeg_encoder = {
    ...
    inSrc_mjpeg_fmts,       // const enum PixelFormat *pix_fmts;
    "MJPEG (Motion JPEG)",  // const char *long_name;
...
AVCodec ff_amv_encoder = {
    "amv",                  // const char *name;
    AVMEDIA_TYPE_VIDEO,     // enum AVMediaType type;
    CODEC_ID_AMV,           // enum CodecID id;
    sizeof(MpegEncContext), // int priv_data_size;
    MPV_encode_init,        // int (*init)(AVCodecContext *);
    amv_encode_picture,     // int (*encode)(AVCodecContext *, uint8_t *buf, int buf_size, void *data);
    MPV_encode_end,         // int (*close)(AVCodecContext *);
    NULL,                   // int (*decode)(AVCodecContext *, void *outdata, int *outdata_size, AVPacket *avpkt);
    0,                      // int capabilities;
    NULL,                   // struct AVCodec *next;
    NULL,                   // void (*flush)(AVCodecContext *);
    NULL,                   // const AVRational *supported_framerates;
    inSrc_amv_fmts,         // const enum PixelFormat *pix_fmts;
    "AMV Video",            // const char *long_name;
    NULL,                   // const int *supported_samplerates;
    NULL,                   // const enum AVSampleFormat *sample_fmts;
    NULL,                   // const uint64_t *channel_layouts;
    0,                      // uint8_t max_lowres;
