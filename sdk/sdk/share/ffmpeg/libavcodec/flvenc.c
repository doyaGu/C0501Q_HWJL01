...
static enum PixelFormat inSrc_flv_fmts[2] = {PIX_FMT_YUV420P, PIX_FMT_NONE};
AVCodec ff_flv_encoder = {
    ...
    inSrc_flv_fmts,         // const enum PixelFormat *pix_fmts;
    "Flash Video (FLV) / Sorenson Spark / Sorenson H.263",  // const char *long_name;
