...
SDL_GLContext
Castor3_OVG_CreateContext(_THIS, SDL_Window * window)
{
...
int 
Castor3_OVG_MakeCurrent(_THIS, SDL_Window * window, SDL_GLContext context)
{
	SDL_VideoData *vdata = (SDL_VideoData *) _this->driverdata;
	SDL_WindowData *wdata = (SDL_WindowData *) window->driverdata;
...
int 
Castor3_OVG_SetSwapInterval(_THIS, int interval)
{
	SDL_VideoData *vdata = (SDL_VideoData *) _this->driverdata;
...
int 
Castor3_OVG_GetSwapInterval(_THIS)
{
	SDL_VideoData *vdata = (SDL_VideoData *) _this->driverdata;
...
void 
Castor3_OVG_SwapWindow(_THIS, SDL_Window * window)
{
	SDL_VideoData *vdata = (SDL_VideoData *) _this->driverdata;
	SDL_WindowData *wdata = (SDL_WindowData *) window->driverdata;
...
void 
Castor3_OVG_DeleteContext(_THIS, SDL_GLContext context)
{
	SDL_VideoData *vdata = (SDL_VideoData *) _this->driverdata;
