...
#undef CreateWindow
    ...
    device->GL_CreateContext = WIN_OVG_CreateContext;
    device->GL_MakeCurrent = WIN_OVG_MakeCurrent;
    device->GL_SetSwapInterval = WIN_OVG_SetSwapInterval;
    device->GL_GetSwapInterval = WIN_OVG_GetSwapInterval;
    device->GL_SwapWindow = WIN_OVG_SwapWindow;
    device->GL_DeleteContext = WIN_OVG_DeleteContext;
#endif
