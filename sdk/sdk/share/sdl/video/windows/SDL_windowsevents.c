        ...
        case WM_DEVICECHANGE:
        {
            ...
            case DBT_DEVICEARRIVAL:
                if (pHdr->dbch_devicetype == DBT_DEVTYP_VOLUME)
                {
                    ...
                    ITPDriveStatus drive = { ITP_DISK_MSC00, ITP_DEVICE_FAT, true };

                    drive.name[0] = GetDriveLetter(pVol->dbcv_unitmask);
                    drive.name[1] = ':';
                    drive.name[2] = '/';

                    write(ITP_DEVICE_DRIVE, &drive, sizeof (ITPDriveStatus));
                }
                break;
            ...
            case DBT_DEVICEREMOVECOMPLETE:
                ...
                {
                    PDEV_BROADCAST_VOLUME pVol = (PDEV_BROADCAST_VOLUME) pHdr;
                    ITPDriveStatus drive = { ITP_DISK_MSC00, ITP_DEVICE_FAT, false };
                    write(ITP_DEVICE_DRIVE, &drive, sizeof (ITPDriveStatus));
                }
                break;
            }
