...
typedef enum {
	...
	RTP_SESSION_MULTICAST_MODE=1<<14
#endif
}RtpSessionFlags;
...
#ifdef ENABLE_VIDEO_MULTICAST
void rtp_session_enable_multicast(void);
void rtp_session_disable_multicast(void);
void rtp_session_reset_multicast(void);
void rtp_session_set_data_status(int value);
int rtp_session_get_data_status(void);
#endif
