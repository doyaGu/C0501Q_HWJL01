 ...
 */
#ifdef _WIN32
typedef __int16 MFT_RECORD_FLAGS;
enum {
 ...
 */
#ifdef _WIN32
typedef __int8 RESIDENT_ATTR_FLAGS;
enum {
 ...
 */
#ifdef _WIN32
typedef __int8 FILE_NAME_TYPE_FLAGS;
enum {
...
#ifdef _WIN32
/* 42*/	ntfschar file_name[1];			/* File name in Unicode. */
#else
 ...
 */
#ifdef _WIN32
typedef __int16 SECURITY_DESCRIPTOR_CONTROL;
enum {
 ...
 */
#ifdef _WIN32
typedef __int8 INDEX_HEADER_FLAGS;
enum {
 ...
 */
#ifdef _WIN32
typedef __int16 INDEX_ENTRY_FLAGS;
enum {
