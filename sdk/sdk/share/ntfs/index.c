				       ...
				       ntfschar *name, u32 name_len)
{
    ...
    {
    #ifdef _WIN32
		(ntfs_index_context*)icx->ni = ni;
		(ntfs_index_context*)icx->name = name;
		(ntfs_index_context*)icx->name_len = name_len;
    #else
...
#ifdef _WIN32
    {
        ntfs_index_context icx2;
        memcpy(&icx2, icx, sizeof (ntfs_index_context));
        memset(icx, 0, sizeof (ntfs_index_context));
	    (ntfs_index_context*)icx->ni = icx2.ni;
	    (ntfs_index_context*)icx->name = icx2.name;
	    (ntfs_index_context*)icx->name_len = icx2.name_len;
    }
#else
	*icx = (ntfs_index_context) {
		.ni = icx->ni,
