...
#ifdef _WIN32
    ntfs_log_trace("dev %p, offset %I64d, whence %i\n", dev, offset, whence);
#else
    ntfs_log_trace("dev %p, offset %lli, whence %i\n", dev, offset, whence);
#endif
...
#ifdef _WIN32
    ntfs_log_trace("dev %p, offset %I64d, count %I64d\n", dev, offset, count);
#else
...
struct ntfs_device_operations ntfs_device_gekko_io_ops = {
    ntfs_device_gekko_io_open,
    ntfs_device_gekko_io_close,
    ntfs_device_gekko_io_seek,
    ntfs_device_gekko_io_read,
    ntfs_device_gekko_io_write,
    ntfs_device_gekko_io_pread,
    ntfs_device_gekko_io_pwrite,
    ntfs_device_gekko_io_sync,
    ntfs_device_gekko_io_stat,
    ntfs_device_gekko_io_ioctl,
};
