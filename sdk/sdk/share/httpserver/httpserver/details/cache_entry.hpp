...
#else
        pthread_mutex_init(&elem_guard, NULL);
#endif
...
#else
        pthread_mutex_destroy(&elem_guard);
#endif
...
#else
                pthread_mutex_unlock(&elem_guard);
#endif
            }
        }
        pthread_mutex_unlock(&lock_guard);
