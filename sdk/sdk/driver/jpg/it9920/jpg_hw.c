    ...
    uint8_t               *pCodeLength)
{
    ...
    // Needs to add new flag for 9920 , Benson .
...
if (!(ithGetDeviceId() == 0x9850 && ithGetRevisionId() > 0))
   ...
   {
       if (bEncodeMode)
           jpgWriteRegMask(REG_JPG_LINE_BUF_ADDR_A_COMPONENT_H,  JPG_MSK_RD_TILING_ENABLE,  JPG_MSK_RD_TILING_ENABLE);
       else
           jpgWriteRegMask(REG_JPG_LINE_BUF_ADDR_A_COMPONENT_H,  JPG_MSK_WR_TILING_ENABLE,  JPG_MSK_WR_TILING_ENABLE);
       ...
       jpgWriteRegMask(REG_JPG_LINE_BUF_ADDR_A_COMPONENT_H,  0,  JPG_MSK_RD_TILING_ENABLE);
       jpgWriteRegMask(REG_JPG_LINE_BUF_ADDR_A_COMPONENT_H,  0,  JPG_MSK_WR_TILING_ENABLE);
	}
#endif	
}
