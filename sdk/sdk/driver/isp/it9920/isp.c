    ...
    if (pISPctxt->UpdateFlags & ISP_FLAGS_UPDATE_PreScaleMatrix)
    {
        ...
        //{
            for (index = 0; index < WEIGHT_NUM; index++)
            {
                ...
                {
                    ISP_SetIntPreScaleMatrix_Reg(pISPctxt->WeightMatInt[index], pISPctxt->ispCore);
                    break;
                }
    ...
    if (pISPctxt->UpdateFlags & ISP_FLAGS_UPDATE_ScaleMatrixH)
    {
        ...
        //{
            for (index = 0; index < WEIGHT_NUM; index++)
            {
                ...
                {
                    ISP_SetIntScaleMatrixH_Reg(pISPctxt->WeightMatInt[index], pISPctxt->ispCore);
                    break;
                }
                else if (index == WEIGHT_NUM - 1)
                    ISP_SetIntScaleMatrixH_Reg(pISPctxt->WeightMatInt[index], pISPctxt->ispCore);
    ...
    if (pISPctxt->UpdateFlags & ISP_FLAGS_UPDATE_ScaleMatrixV)
    {
        ...
        //{
            for (index = 0; index < WEIGHT_NUM; index++)
            {
                ...
                {
                    ISP_SetIntScaleMatrixV_Reg(pISPctxt->WeightMatInt[index], pISPctxt->ispCore);
                    break;
                }
                else if (index == WEIGHT_NUM - 1)
                    ISP_SetIntScaleMatrixV_Reg(pISPctxt->WeightMatInt[index], pISPctxt->ispCore);
            ...
            if (pISPctxt->UpdateFlags & ISP_FLAGS_UPDATE_PVScaleMatrixH)
            {
                ...
                //{
                    for (index = 0; index < WEIGHT_NUM; index++)
                    {
                        ...
                        {
                            ISP_SetIntPVScaleMatrixH_Reg(pISPctxt->WeightMatInt[index], pISPctxt->ispCore);
                            break;
                        }
                        else if (index == WEIGHT_NUM - 1)
                            ISP_SetIntPVScaleMatrixH_Reg(pISPctxt->WeightMatInt[index], pISPctxt->ispCore);
            ...
            if (pISPctxt->UpdateFlags & ISP_FLAGS_UPDATE_PVScaleMatrixV)
            {
                ...
                //{
                    for (index = 0; index < WEIGHT_NUM; index++)
                    {
                        ...
                        {
                            ISP_SetIntPVScaleMatrixV_Reg(pISPctxt->WeightMatInt[index], pISPctxt->ispCore);
                            break;
                        }
                        else if (index == WEIGHT_NUM - 1)
                            ISP_SetIntPVScaleMatrixV_Reg(pISPctxt->WeightMatInt[index], pISPctxt->ispCore);
