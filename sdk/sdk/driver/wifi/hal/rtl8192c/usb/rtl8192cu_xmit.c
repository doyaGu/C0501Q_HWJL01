...
//	struct hw_xmit *phwxmit;
	...
	//printf("rtl8192cu_xmitframe_complete in\n");
	...
	do {
		...
		if (pxmitframe == NULL) {
			...
			//printf("no more xmit frame, release xmit buffer rtl8192cu_xmitframe_complete out\n");
			return _FALSE;
		}
...
//		pxmitframe->pxmitbuf = pxmitbuf;
	...
	//printf("rtl8192cu_xmitframe_complete out\n");
...
//#if (LINUX_VERSION_CODE < KERNEL_VERSION(2,6,18)) // http://www.mail-archive.com/netdev@vger.kernel.org/msg17214.html
	...
	urb->transfer_flags |= USB_ZERO_PACKET; //James
