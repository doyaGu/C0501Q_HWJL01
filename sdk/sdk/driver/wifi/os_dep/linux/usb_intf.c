...
//static void* rtw_drv_init(struct usb_device *dev, unsigned int usb_interface,const struct usb_device_id *pdid);

static void rtw_dev_remove(struct usb_interface *pusb_intf);
//static void rtw_dev_remove(struct usb_device *dev, void *ptr);
...
static struct usb_device_id rtw_usb_id_tbl[] ={
	...
	/******8188CTV**********/
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0x18a)},//8188ctv : James add
	
	/******8188EUS**********/
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0x8179)},//8188eus : James add
...
int const  rtw_usb_id_tbl_len = sizeof(rtw_usb_id_tbl) / sizeof(struct usb_device_id);
...
struct usb_driver rtlusb_driver = 
{
    "rtl8192cu",             /** driver name */
    0,                  /** flag */
    rtw_drv_init,    /** probe function */
    NULL,           /** open function */
    rtw_dev_remove,/** disconnect function */
    NULL,           /** ioctl */
    rtw_usb_id_tbl,       /** id table */
...
static int __init rtw_drv_entry(void)
{
	...
	return usb_register(&rtlusb_driver);
}
...
{   
    ...
    sem_init(x, 0, 1); 
	INIT_LIST_HEAD(&rtlusb_driver.driver_list);
	rtlusb_driver.serialize = x;
#endif
