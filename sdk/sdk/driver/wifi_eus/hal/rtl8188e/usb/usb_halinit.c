	...
	)
{
	...
	Hal_EfuseParseIDCode88E(padapter, PROMContent);

	Hal_EfuseParsePIDVID_8188EU(padapter, PROMContent, pEEPROM->bautoload_fail_flag);


#ifdef CONFIG_EFUSE_CONFIG_FILE
	Hal_ReadMACAddrFromFile_8188EU(padapter);
#else //CONFIG_EFUSE_CONFIG_FILE	
	Hal_EfuseParseMACAddr_8188EU(padapter, PROMContent, pEEPROM->bautoload_fail_flag);


#endif //CONFIG_EFUSE_CONFIG_FILE	

	Hal_ReadPowerSavingMode88E(padapter, PROMContent, pEEPROM->bautoload_fail_flag);


	Hal_ReadTxPowerInfo88E(padapter, PROMContent, pEEPROM->bautoload_fail_flag);	


	Hal_EfuseParseEEPROMVer88E(padapter, PROMContent, pEEPROM->bautoload_fail_flag);


	rtl8188e_EfuseParseChnlPlan(padapter, PROMContent, pEEPROM->bautoload_fail_flag);


	Hal_EfuseParseXtal_8188E(padapter, PROMContent, pEEPROM->bautoload_fail_flag);


	Hal_EfuseParseCustomerID88E(padapter, PROMContent, pEEPROM->bautoload_fail_flag);


	Hal_ReadAntennaDiversity88E(padapter, PROMContent, pEEPROM->bautoload_fail_flag);


	Hal_EfuseParseBoardType88E(padapter, PROMContent, pEEPROM->bautoload_fail_flag);


	Hal_ReadThermalMeter_88E(padapter, PROMContent, pEEPROM->bautoload_fail_flag);
	...
	_ReadLEDSetting(padapter, PROMContent, pEEPROM->bautoload_fail_flag);
