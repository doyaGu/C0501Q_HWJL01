...
static void usb_read_interrupt_complete(struct urb *purb, struct pt_regs *regs)
{
	...
	if(purb->status==0)//SUCCESS
	{
		...
		//err = usb_submit_urb(purb, GFP_ATOMIC); //James
...
_func_enter_;
	...
	//err = usb_submit_urb(precvpriv->int_in_urb, GFP_ATOMIC); //James
...
static int nornalFail = 0;
static int enqueueN = 0;
