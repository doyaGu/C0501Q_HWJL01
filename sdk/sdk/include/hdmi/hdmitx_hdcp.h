...
SYS_STATUS hdmitx_hdcp_GetBCaps(PBYTE pBCaps ,unsigned int *pBStatus);
...
SYS_STATUS hdmitx_hdcp_CheckSHA(BYTE pM0[],unsigned int BStatus,BYTE pKSVList[],int cDownStream,BYTE Vr[]);
