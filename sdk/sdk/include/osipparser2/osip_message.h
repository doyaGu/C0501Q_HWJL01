...
/**
 * Test if the message is a response with status 100
 * @param msg the SIP message.
 */
#define MSG_IS_STATUS_100(msg) ((msg)->status_code == 100)
...
/**
 * Test if the message is a response with status 200
 * @param msg the SIP message.
 */
#define MSG_IS_STATUS_200(msg) ((msg)->status_code == 200)
/**
