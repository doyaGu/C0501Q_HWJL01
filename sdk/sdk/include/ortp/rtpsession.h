...
/* IP TTL*/
ORTP_PUBLIC int rtp_session_set_ip_ttl(RtpSession *session, int ttl);
...
ORTP_PUBLIC void rtp_session_set_multicast_rtp (RtpSession * session, bool_t yesno);
