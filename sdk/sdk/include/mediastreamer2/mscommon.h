...
// [iclai+] we always print debug message under win32 environment
...
#define ms_thread_create    pthread_create
 ...
 */
#define ms_init()   ms_base_init(), ms_voip_init()/*, ms_plugins_init()*/   // [iclai] we don't support plugin

/**
 * Helper macro for backward compatibility.
 * Use ms_base_exit() and ms_voip_exit() instead.
 */
#define ms_exit()   ms_voip_exit()/*, ms_plugins_exit()*/, ms_base_exit()   // [iclai] we don't support plugin
