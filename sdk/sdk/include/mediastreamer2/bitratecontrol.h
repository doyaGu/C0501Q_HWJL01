...
MS2_PUBLIC MSBitrateDriver *ms_audio_bitrate_driver_new(MSFilter *encoder);
MS2_PUBLIC MSBitrateDriver *ms_av_bitrate_driver_new(MSFilter *aenc, MSFilter *venc);
