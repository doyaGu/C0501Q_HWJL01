...
namespace GUIDesigner
{
    class PopupRadioBoxWidget : RadioButton, IWidget
    {
        ...
        public ITUWidget CreateITUWidget()
        {
            ...
            {
                prb.staticSurf = ITU.CreateSurfaceNode(this.BackgroundImage as Bitmap, this.PixelFormat, this.Compress, this.External);
                if (this.External)
                    prb.flags |= ITU.ITU_EXTERNAL;
            }
            ...
            {
                prb.staticFocusSurf = ITU.CreateSurfaceNode(this.FocusImage as Bitmap, this.PixelFormat, this.Compress, this.External);
                if (this.External)
                    prb.flags |= ITU.ITU_EXTERNAL;
            }            
            ...
            {
                prb.staticCheckedSurf = ITU.CreateSurfaceNode(this.CheckedImage as Bitmap, this.PixelFormat, this.Compress, this.External);
                if (this.External)
                    prb.flags |= ITU.ITU_EXTERNAL;
            }            
            ...
            {
                prb.staticFocusCheckedSurf = ITU.CreateSurfaceNode(this.FocusCheckedImage as Bitmap, this.PixelFormat, this.Compress, this.External);
                if (this.External)
                    prb.flags |= ITU.ITU_EXTERNAL;
            }
