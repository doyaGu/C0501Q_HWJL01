...
int codec_ex_start(void) __attribute__ ( ( naked ) );
//extern int codec_info();
//extern AUDIO_CODEC_STREAM* gpAudioStream;
#if 1 //defined(AUDIO_PLUGIN_MESSAGE_QUEUE)

struct _codec_header __header __attribute__ ((section (".codec_ex_header"))) = {
...
#else
const struct _codec_header __header __attribute__ ((section (".codec_ex_header"))) = {
    (unsigned long)0x0, (unsigned short)0x0, (unsigned short)0x0,
    (unsigned char*)risc2_start_addr, (unsigned char*)risc2_end_addr,
...
// startup entry
//int wiegand_start(struct _codec_api *api)
int codec_ex_start(void)
{
