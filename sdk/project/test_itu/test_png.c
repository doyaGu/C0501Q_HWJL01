...
int SDL_main(int argc, char *argv[])
{
    ...
    window = SDL_CreateWindow("ITU PNG Test",
    ...
    ituSceneLoadFile(&scene, CFG_PRIVATE_DRIVE ":/png.itu");
    ...
    // get png icon to load
    icon = (ITUIcon*)ituSceneFindWidget(&scene, "Icon1");
    if (icon)
    {
        ituIconLoadPngFile(icon, CFG_PRIVATE_DRIVE ":/icon.png");
    }
